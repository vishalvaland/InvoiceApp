            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::open(['method' => 'GET', 'url' => '/customer', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>ID</th><th>Customer Name</th><th>Customer Address</th><th>GST No.</th> <th>Mobile No.</th> <th>E-Mail</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($customer as $item)
                                    <tr>
                                        <td>{{ $item->id }}</td>
                                        <td>{{ $item->CustomerName }}</td><td>{{ $item->CustomerAddress }}</td><td>{{ $item->GSTNo }}</td>
                                           <td> {{ $item->MobileNo }} </td>
                                     <td> {{ $item->EMail }} </td>
                                        <td>
